...
export default function DocumentViewer({
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-gray-900 to-black p-8">
            <div className="text-center max-w-2xl">
                <div className="mb-6 flex justify-center">{getFileIcon(extension)}</div>

                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-2">{title}</h2>
                    <p className="text-gray-400 text-lg mb-1">{getFileTypeName(extension)}</p>
                    <p className="text-gray-500 text-sm">{extension.toUpperCase()} File</p>
                </div>
